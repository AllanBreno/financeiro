...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeira",sLast:"Última",sNext:"Próxima",sPrevious:"Anterior"},sEmptyTable:"No data available in table",sInfo:"Exibindo _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 to 0 of 0 registros",
sInfoFiltered:"(filtered from _MAX_ total registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibir _MENU_ registros",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Busca:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
